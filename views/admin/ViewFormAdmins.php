...
<div class="col-md-12">  
    <div class="panel panel-primary">
        <div class="panel-heading"><b>Add edit admin</b></div>
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $action; ?>">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <img src="assets/upload/news/<?php echo $record->avatar; ?>" style="width: 100px;" alt="" srcset="">
                </div>
            </div>
            <!-- end rows -->
            <?php endif; ?>
           ...
           <div class="row" style="margin-top:5px;">
            ...
            <!-- end rows -->
               ...
               <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="checkbox" <?php if(isset($record->role_type)&&$record->role_type==1): ?> checked <?php endif; ?> name="role_type" id="hot"> <label for="hot">&nbsp;&nbsp;Role</label>
                </div>
            </div>
            <!-- rows -->
            <div class="row" style="margin-top:5px;">
