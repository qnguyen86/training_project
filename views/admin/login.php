        ...
        <div id="login-row" class="row justify-content-center align-items-center">
            <div id="login-column" class="col-md-6">
                <div id="login-box" class="col-md-12">
                    <form id="login-form" class="form" action="index.php?controller=admin&action=login" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" name="btn-login" class="btn btn-info btn-md" value="submit">
                        </div>
